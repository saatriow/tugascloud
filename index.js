function getData(location) {
    return fetch("https://data.bmkg.go.id/DataMKG/MEWS/DigitalForecast/DigitalForecast-JawaTengah.xml") 
...
weatherPanel(["Semarang", "Boyolali", "Surakarta", "Karanganyar", "Klaten", "Magelang"])
